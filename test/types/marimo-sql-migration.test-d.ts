...
function completionRoute(
  ...
  switch (connection.dialect) {
    case "bigquery":
      return { connection, dialect: "bigquery", kind: "standard" };
    case "dremio":
      return { connection, dialect: "dremio", kind: "standard" };
    case "duckdb":
      return { connection, dialect: "duckdb", kind: "standard" };
    case "postgres":
    case "postgresql":
      return { connection, dialect: "postgres", kind: "standard" };
    case "mysql":
    case "oracle":
    case "sqlite":
    case "snowflake":
...
declare const duckdbRoute: SqlCompletionRoute;
declare const secondDuckdbRoute: SqlCompletionRoute;
declare const mysqlConnection: MarimoConnection & {
  readonly dialect: "mysql";
};

const firstSupport = createSqlSupport(
  duckdbRoute,
  "SELECT * FROM {df}",
);
const secondSupport = createSqlSupport(
  secondDuckdbRoute,
  "SELECT * FROM users",
);
